...
class FGMembersite
{
    ...
    function RegisterUser()
    {
        ...
        header("Location: thank-you-regd.html");
    ...
    function CheckLoginInDB($username,$password)
    {
  	...
  	$nresult = mysql_query("SELECT * FROM $this->tablename WHERE username = '$username'", $this->connection) or die(mysql_error());
        ...
        $qry = "Select id_user, name, email, phone_number, username from $this->tablename where username='$username' and password='$hash' and status='1'";
